...
export default function SectorHome({ triggerWarp = () => {} }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} className="apple-reveal apple-reveal-delay-1">
        
        {/* Availability & Direct Phone Badge */}
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', padding: '6px 18px', background: 'rgba(16, 185, 129, 0.1)', border: '1px solid rgba(16, 185, 129, 0.25)', borderRadius: '9999px', marginBottom: '20px', flexWrap: 'wrap', justifyContent: 'center' }}>
        ...
        <div style={{ marginBottom: '14px' }}>
          <h2 style={{ fontSize: '1.5rem', fontFamily: 'var(--font-header)', fontWeight: 800, letterSpacing: '0.04em', color: 'var(--text-primary)', margin: '0 0 4px 0' }}>
            ANIK SHAKYA
          </h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '20px', width: '100%' }}>
        ...
        {/* Tile 1: Track Record Metrics (4 Columns) */}
        <div 
          className="editorial-card apple-reveal apple-reveal-delay-2" 
          style={{ gridColumn: 'span 4', padding: '28px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', margin: '16px 0' }}>
            <div>
              <span style={{ fontSize: '2.2rem', fontWeight: 800, color: 'var(--accent-primary)', fontFamily: 'var(--font-header)' }}>5+</span>
              <span style={{ fontSize: '13px', color: 'var(--text-secondary)', display: 'block', fontWeight: 500 }}>Live Deployed Mobile Apps</span>
            </div>
            <div>
              <span style={{ fontSize: '2.2rem', fontWeight: 800, color: 'var(--accent-secondary)', fontFamily: 'var(--font-header)' }}>4+ Yrs</span>
              <span style={{ fontSize: '13px', color: 'var(--text-secondary)', display: 'block', fontWeight: 500 }}>Production Mobile Development</span>
            </div>
            <div>
              <span style={{ fontSize: '2.2rem', fontWeight: 800, color: 'var(--accent-emerald)', fontFamily: 'var(--font-header)' }}>100%</span>
              <span style={{ fontSize: '13px', color: 'var(--text-secondary)', display: 'block', fontWeight: 500 }}>Client Satisfaction & Quality</span>
            </div>
          </div>

          <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
            <a href="https://github.com/AnikShakya" target="_blank" rel="noopener noreferrer" className="btn-editorial" style={{ fontSize: '11px', padding: '6px 12px' }}>GitHub</a>
            <a href="https://www.linkedin.com/in/anik-shakya-67141b192/" target="_blank" rel="noopener noreferrer" className="btn-editorial" style={{ fontSize: '11px', padding: '6px 12px' }}>LinkedIn</a>
            <a href="https://wa.me/9779863021878" target="_blank" rel="noopener noreferrer" className="btn-editorial" style={{ fontSize: '11px', padding: '6px 12px' }}>WhatsApp</a>
          </div>
        </div>

        {/* Tile 2: Featured Work Highlights (8 Columns) */}
        <div 
          className="editorial-card apple-reveal apple-reveal-delay-3" 
          style={{ gridColumn: 'span 8', padding: '28px' }}
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
            <h3 style={{ fontSize: '1.3rem', fontFamily: 'var(--font-header)', fontWeight: 800, margin: 0, letterSpacing: '-0.02em' }} className="headline-gradient">
              ...
              >
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '6px', flexWrap: 'wrap', gap: '6px' }}>
                    ...
                    <span className="hud-monospace" style={{ fontSize: '8.5px', color: item.tagColor, padding: '2px 8px', background: 'rgba(0,0,0,0.06)', borderRadius: '9999px' }}>
                      {item.cat}
                    </span>
                  </div>
